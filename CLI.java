...
public class CLI {
    ...
    public static final String ERRMSG_DIAGONALS = "Error: With $d arguments, the 1st must be `%s`\n";
    public static final String ERRMSG_NBARGS = "Error: The program must be called with either 2 or 3 arguments.\n";
        ...
        switch (argv.size()) {
            case 3:
                if (argv.get(0).equals(DIAGONALS_OPTION)) {
                    ...
                    System.err.printf(ERRMSG_DIAGONALS, argv.size(), DIAGONALS_OPTION);
                    System.exit(-1);
                }
                /* FALL THROUGH */
            case 2:
